    ...
    public static class DataMapper
    {
        ...
        static void BuildOperandTypeCastMap()
        {
            ...
            OperandTypeCastMap.Add(OperatorType.Multiply, new Dictionary<DTP, DTP>()
            {
                ...
                { new DTP(DataType.Timespan,            DataType.UnlimitedInteger),     new DTP(DataType.Timespan,              DataType.UnlimitedInteger) },
            ...
            #region Power
            OperandTypeCastMap.Add(OperatorType.Power, OperandTypeCastMap[OperatorType.Multiply]);
            #endregion Power

            #region Root
            OperandTypeCastMap.Add(OperatorType.Root, OperandTypeCastMap[OperatorType.Multiply]);
            #endregion Root

            #region Modulo
            OperandTypeCastMap.Add(OperatorType.Modulo, OperandTypeCastMap[OperatorType.Divide]);
            #endregion Modulo
