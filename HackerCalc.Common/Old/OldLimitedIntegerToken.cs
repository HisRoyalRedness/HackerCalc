...
//{
//    public class OldLimitedIntegerToken : OldLiteralToken<BigInteger, OldLimitedIntegerToken>
//    {
//        #region Constructors
//        public OldLimitedIntegerToken(BigInteger typedValue, IntegerBitWidth bitWidth, bool isSigned)
...
//                throw new ParseException($"{typedValue} is less than the minimum of {limit.Min} for a {bitWidth.GetEnumDescription()}-bit {(isSigned ? "signed" : "unsigned")} {nameof(OldLimitedIntegerToken)} ");
//            else if (typedValue > limit.Max)
//                throw new ParseException($"{typedValue} is greater than the maximum of {limit.Max} for a {bitWidth.GetEnumDescription()}-bit {(isSigned ? "signed" : "unsigned")} {nameof(OldLimitedIntegerToken)} ");
//        }

//        OldLimitedIntegerToken(BigInteger typedValue, BitWidthAndSignPair signAndBitWidth)
//            : this(typedValue, signAndBitWidth.BitWidth, signAndBitWidth.IsSigned)
//        { }

//        OldLimitedIntegerToken(BigInteger typedValue, IntegerBitWidth bitWidth, bool isSigned, bool isNeg)
//            : this((isNeg ? typedValue * -1 : typedValue), bitWidth, isSigned)
//        { }

//        static OldLimitedIntegerToken()
//        {
...
//        #region Parsing
//        public static OldLimitedIntegerToken Parse(string value, IntegerBase numBase, string bitWidth, bool isSigned, bool isNeg = false)
//            => Parse(value, numBase, ParseBitWidth(bitWidth), isSigned, isNeg);
//        public static OldLimitedIntegerToken Parse(string value, IntegerBase numBase, IntegerBitWidth bitWidth, bool isSigned,bool isNeg = false)
//        {
//            switch (numBase)
//            {
//                case IntegerBase.Binary:
//                    return new OldLimitedIntegerToken(value.Replace("b", "").Replace("B", "").BigIntegerFromBinary(), bitWidth, isSigned, isNeg);
//                case IntegerBase.Decimal:
//                    return new OldLimitedIntegerToken(BigInteger.Parse(value, NumberStyles.Integer), bitWidth, isSigned, isNeg);
//                case IntegerBase.Hexadecimal:
//                    return new OldLimitedIntegerToken(BigInteger.Parse(value.Replace("0x", "00").Replace("0X", "00"), NumberStyles.HexNumber), bitWidth, isSigned, isNeg);
//                default:
...
//        public static OldLimitedIntegerToken operator +(OldLimitedIntegerToken a, OldLimitedIntegerToken b)
//            => new OldLimitedIntegerToken(a.TypedValue + b.TypedValue, Upcast(a.SignAndBitWidth, b.SignAndBitWidth));
//        public static OldLimitedIntegerToken operator -(OldLimitedIntegerToken a, OldLimitedIntegerToken b)
//            => new OldLimitedIntegerToken(a.TypedValue - b.TypedValue, Upcast(a.SignAndBitWidth, b.SignAndBitWidth));
//        public static OldLimitedIntegerToken operator *(OldLimitedIntegerToken a, OldLimitedIntegerToken b)
//            => new OldLimitedIntegerToken(a.TypedValue * b.TypedValue, Upcast(a.SignAndBitWidth, b.SignAndBitWidth));
...
//            => new OldLimitedIntegerToken(TypedValue * -1, SignAndBitWidth);

//        public override IOldLiteralToken BitwiseNegate()
//            => throw new InvalidOperationException($"{nameof(OldLimitedIntegerToken)} does not support {nameof(BitwiseNegate)}, as it doesn't have a fixed bit width.");

//        public OldLimitedIntegerToken LeftShift(int shift)
//            => new OldLimitedIntegerToken(TypedValue << shift, SignAndBitWidth);

//        public OldLimitedIntegerToken RightShift(int shift)
//            => new OldLimitedIntegerToken(TypedValue >> shift, SignAndBitWidth);
...
//        public OldLimitedIntegerToken Upcast(IntegerBitWidth bitWidth, bool isSigned)
//        {
...
//                ? this
//                : new OldLimitedIntegerToken(TypedValue, signAndBitWidth);
//        }
...
//        #region Equality
//        public override bool Equals(object obj) => Equals(obj as OldLimitedIntegerToken);
//        public override bool Equals(OldLimitedIntegerToken other) => other is null ? false : (TypedValue == other.TypedValue);
//        public override int GetHashCode() => TypedValue.GetHashCode();

//        public static bool operator ==(OldLimitedIntegerToken a, OldLimitedIntegerToken b)
//        {
...
//        }
//        public static bool operator !=(OldLimitedIntegerToken a, OldLimitedIntegerToken b) => !(a == b);
//        #endregion Equality

//        #region Comparison
//        public override int CompareTo(OldLimitedIntegerToken other) => other is null ? 1 : TypedValue.CompareTo(other.TypedValue);
...
//            public MinAndMax(OldLimitedIntegerToken.IntegerBitWidth bitWidth, bool isSigned)
//            {
