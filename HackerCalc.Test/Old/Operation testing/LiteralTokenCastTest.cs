...
//            {
//                var maxSigned = OldLimitedIntegerToken.MaxValue(new OldLimitedIntegerToken.BitWidthAndSignPair(bw, true));
//                var maxUnsigned = OldLimitedIntegerToken.MaxValue(new OldLimitedIntegerToken.BitWidthAndSignPair(bw, false));

//                // First get the smallest signed integer for our number
//                var limited = new UnlimitedIntegerToken(maxSigned).CastTo<OldLimitedIntegerToken>();
...
//                limited = new UnlimitedIntegerToken(maxSigned + 1).CastTo<OldLimitedIntegerToken>();
...
//                limited = new UnlimitedIntegerToken(maxUnsigned).CastTo<OldLimitedIntegerToken>();
...
//            foreach (var bw in EnumExtensions.GetEnumCollection<OldLimitedIntegerToken.IntegerBitWidth>())
//            {
//                var minSigned = OldLimitedIntegerToken.MaxValue(new OldLimitedIntegerToken.BitWidthAndSignPair(bw, true));

//                // First get the smallest signed integer for our number
//                var limited = new UnlimitedIntegerToken(minSigned).CastTo<OldLimitedIntegerToken>();
...
//        {
//            var max = new UnlimitedIntegerToken(OldLimitedIntegerToken.MaxValue(new OldLimitedIntegerToken.BitWidthAndSignPair(OldLimitedIntegerToken.IntegerBitWidth._128, false)) + 1);
//            new Action(() => max.CastTo<OldLimitedIntegerToken>()).Should().Throw<IntegerOverflowException>($"it is 1 greater than the largest allowable {nameof(OldLimitedIntegerToken)} value");

//            var min = new UnlimitedIntegerToken(OldLimitedIntegerToken.MinValue(new OldLimitedIntegerToken.BitWidthAndSignPair(OldLimitedIntegerToken.IntegerBitWidth._128, true)) - 1);
//            new Action(() => min.CastTo<OldLimitedIntegerToken>()).Should().Throw<IntegerOverflowException>($"it is 1 less than the smallest allowable {nameof(OldLimitedIntegerToken)} value");
//        }
