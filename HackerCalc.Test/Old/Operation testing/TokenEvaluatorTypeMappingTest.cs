...
//                result.Should().BeAssignableTo<IOldLiteralToken>();
...
//                    ((IOldLiteralToken)result).DataType.Should().Be(opProp.ResultMap[castPair], "the result type should match the specified type in the result map");
//                }
//            }
