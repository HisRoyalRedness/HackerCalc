...
namespace HisRoyalRedness.com
{
    ...
    public class IntegerParseTest
    {
        ...
        */
        ...
        {
            var bitWidths = Enum.GetValues(typeof(IntegerToken.IntegerBitWidth)).Cast<IntegerToken.IntegerBitWidth>().Where(bw => bw != IntegerToken.IntegerBitWidth.Unbound).ToList();
        ...
        void TestLimit(bool isSigned, IntegerToken.IntegerBitWidth bitWidth, bool testMin)
        {
