...
namespace HisRoyalRedness.com
{
    ...
    public class AddOperatorTest
    {
        ...
        [TypedDataRow("2u4 + 3.1",                      "5.1f",                     DataType.IrrationalNumber)]
        ...
        [TypedDataRow("2 + 3",                          "5",                        DataType.RationalNumber)]
        [TypedDataRow("2 + 3.1",                        "5.1f",                     DataType.IrrationalNumber)]
        [TypedDataRow("2 + 2019-01-23 12:34:56",        null,                       null)]
        [TypedDataRow("2 + 12:34:56",                   null,                       null)]
        [TypedDataRow("2 + 10hrs",                      null,                       null)]
        // Float
        [TypedDataRow("2.6 + 3u4",                      "5.6f",                     DataType.IrrationalNumber)]
        [TypedDataRow("2.6 + 3",                        "5.6f",                     DataType.IrrationalNumber)]
        [TypedDataRow("2.6 + 3.1",                      "5.7f",                     DataType.IrrationalNumber)]
