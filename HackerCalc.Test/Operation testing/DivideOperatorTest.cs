...
namespace HisRoyalRedness.com
{
    ...
    public class DivideOperatorTest
    {
        ...
        [TypedDataRow("6u4 / 2.5",                      "2.4f",                     DataType.Float)]
        ...
        [TypedDataRow("6 / 2",                          "3",                        DataType.UnlimitedInteger)]
        [TypedDataRow("6 / 2.5",                        "2.4f",                     DataType.Float)]
        [TypedDataRow("6 / 2019-01-23 12:34:56",        null,                       null)]
        [TypedDataRow("6 / 12:34:56",                   null,                       null)]
        [TypedDataRow("6 / 10hrs",                      null,                       null)]
        // Float
        [TypedDataRow("6.2 / 2u4",                      "3.1f",                     DataType.Float)]
        [TypedDataRow("6.2 / 2",                        "3.1f",                     DataType.Float)]
        [TypedDataRow("6.2 / 3.1",                      "2.0f",                     DataType.Float)]
        ...
        [TypedDataRow("12h34m45s / 20mins",             "37.7375f",                 DataType.Float)]
        ...
        static readonly Dictionary<DataType, HashSet<DataType>> _supportedOperatorPairs = new Dictionary<DataType, HashSet<DataType>>
        {
            ...
            */
            ...
            { DataType.Timespan,            new HashSet<DataType> { DataType.LimitedInteger, DataType.UnlimitedInteger, DataType.Float, DataType.Timespan } },
        };
